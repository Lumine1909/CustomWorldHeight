...
public class DataHandler_1_21_6 implements DataHandler<DimensionType, Holder<DimensionType>, ResourceKey<DimensionType>> {
    ...
    public LevelData<DimensionType, ResourceKey<DimensionType>, Holder<DimensionType>> createData(Identifier id, Height height, BaseDimensionType dimension) {
        LevelData<DimensionType, ResourceKey<DimensionType>, Holder<DimensionType>> levelData = new LevelData_1_21_6(id, height, dimension);
        switch (dimension) {
    ...
    public void processData(LevelData<DimensionType, ResourceKey<DimensionType>, Holder<DimensionType>> data, Holder<DimensionType> holder) {
        ...
        DimensionType newDimension = new DimensionType(
            ...
            old.ambientLight(), data.computeCloudHeightInteger(old.cloudHeight()), old.monsterSettings()
        );
    ...
    public void processWorld(World world, LevelData<DimensionType, ResourceKey<DimensionType>, Holder<DimensionType>> data) {
        ...
        level.setSectionsCount(sectionsCount);

        StarLightInterfaceProxy lightInterface = StarLightInterfaceProxy.wrap(serverLevel.getLightEngine().starlight$getLightEngine());
