...
public class DataHandler_1_21_6 implements DataHandler<DimensionType, Holder<DimensionType>, ResourceKey<DimensionType>> {
    ...
    public LevelData<DimensionType, ResourceKey<DimensionType>, Holder<DimensionType>> createData(String name, Height height, BaseDimension dimension) {
        LevelData<DimensionType, ResourceKey<DimensionType>, Holder<DimensionType>> levelData = new LevelData_1_21_6(name, height, dimension);
        switch (dimension) {
    ...
    public void processData(LevelData<DimensionType, ResourceKey<DimensionType>, Holder<DimensionType>> data, Holder<DimensionType> holder) {
        ...
        DimensionType newDimension = new DimensionType(
            ...
            old.ambientLight(), data.getCloudHeight(old.cloudHeight()), old.monsterSettings()
        );
