...
public class DataHandler_26_2 implements DataHandler<DimensionType, Holder<DimensionType>, ResourceKey<DimensionType>> {
    ...
    public LevelData<DimensionType, ResourceKey<DimensionType>, Holder<DimensionType>> createData(io.github.lumine1909.customworldheight.api.Identifier id, Height height, BaseDimensionType dimension) {
        LevelData<DimensionType, ResourceKey<DimensionType>, Holder<DimensionType>> levelData = new LevelData_26_2(id, height, dimension);
        switch (dimension) {
