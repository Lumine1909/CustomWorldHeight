...
public class LevelData_26_2 extends LevelData<DimensionType, ResourceKey<DimensionType>, Holder<DimensionType>> {

    public LevelData_26_2(Identifier id, Height height, BaseDimensionType dimension) {
